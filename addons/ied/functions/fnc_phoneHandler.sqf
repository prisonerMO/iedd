 ...
 *
 * Example:
 * [_unit] call iedd_ied_fnc_phoneHandler;
 *
 * Public: No
 */
...
private _ied = _unit getVariable [QGVAR(ied), objNull];

_group setVariable [QGVAR(ied), _ied, true];
_group setVariable [QGVAR(unit), _unit, true];
